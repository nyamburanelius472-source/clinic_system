...
<div style="background:#fff; padding:20px 30px; box-shadow:0 2px 8px rgba(13,115,119,0.1);">
    <div style="max-width:1100px; margin:0 auto; display:flex; justify-content:space-around; align-items:center;">
...
<div style="background:#F0FAF9; padding:40px 30px;">
    <div style="max-width:1100px; margin:0 auto;">
        ...
        <div style="display:flex; gap:20px; flex-wrap:wrap; justify-content:center;">
            ...
            <div style="background:#fff; border-radius:12px; padding:28px 24px; flex:1; min-width:220px; text-align:center; border-left:4px solid #14A085; box-shadow:0 2px 8px rgba(13,115,119,0.08);">
